...
public final class Test1 {
	...
	public static void main(String[] args) {
		...
		VeterinariaControlador.llegadaAnimal(3, "juni", 1, "Pitbull", 5, "Muerde a los pendejos");
		VeterinariaControlador.llegadaAnimal(4, "lulo", 2, "desconosido", 6, "No come nada");
		VeterinariaControlador.llegadaAnimal(5, "Esculapio", 3, "desconosido", 6, "Morfa zanahoria como un HDP!");
		...
		VeterinariaControlador.BusquedaMascota(12);
		...
		VeterinariaControlador.llegadaAnimal(21, "Menem", 1, "gran danes",  4, "se choca contra las paredes");
		VeterinariaControlador.llegadaAnimal(22, "Chapatin", 2, "desconosido", 2, "falta de animo");
		VeterinariaControlador.llegadaAnimal(23, "De la Vega", 1, "Pitbull", 5, "falta de animo");
		
		
		VeterinariaControlador.llegadaAnimal(24, "Batman", 2, "desconosido", 6, "No come nada");
		VeterinariaControlador.llegadaAnimal(25, "Superman", 3, "desconosido", 6, "Morfa zanahoria como un HDP!");
